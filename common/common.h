...
#ifdef SAMP_03c
	#define RAKSAMP_VERSION "v0.5-0.3c"
...
#ifdef SAMP_03d
	#define RAKSAMP_VERSION "v0.5-0.3d"

	#define NETCODE_OPENCONNLULZ 5
	#define NETGAME_VERSION 8910
	#define AUTH_BS "381356A6B4349449E8F818B06B405A4FBBE9F8DDDAB"
#endif

#ifdef SAMP_03e
#ifndef BULLSHIT_03e_R2
	#define RAKSAMP_VERSION "v0.5-0.3e"
#else
	#define RAKSAMP_VERSION ""
#endif
	#define NETCODE_OPENCONNLULZ 0x4196 //kye rlz! :D
	#define NETGAME_VERSION 8920 //search text: "offset aInvalidClien_" -> next function shows version number in "xor ecx, ****"
	#define AUTH_BS "12DED44BF544BEE74D4A24747ADA05FB7005EFDB0B6"
#endif
